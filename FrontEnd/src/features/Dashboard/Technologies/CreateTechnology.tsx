import { Box, Typography , FormControl  , InputLabel ,Input ,FormHelperText, Button , Select, MenuItem }  from '@mui/material'
import React from 'react'
import { TechType, type Technology } from '../../../Types/Technology'
import { generateFromDataFromRefObject, handleInputChangeIntoARefObject } from '../../../Helpers/FieldVerifier'
...
function CreateTechnology({}: Props) {
  ...
  const handleSubmit : ()=>Promise<void> = async()=>{
    try {
      const result = await axios.post (`${apiUrl}/api/technologies/`, generateFromDataFromRefObject(createdTech))
      result && handleSuccess("Inserting the Technology" , "Success Inserting Technology")
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Input onChange={(e) => handleInputChangeIntoARefObject( createdTech ,e, "name")} />
      ...
      <FormControl fullWidth>
        ...
        <Select
          ...
          label="Age"
          onChange={(e)=>handleInputChangeIntoARefObject(createdTech , e,  "technologyType")}
        >
      ...
      >
        ...
        <Input onChange={(e) => handleInputChangeIntoARefObject( createdTech ,e,"score")} />
        <FormHelperText id="my-helper-text">
          0 TO 1
        </FormHelperText>
      </FormControl>
      ...
      >
        ...
        <Input onChange={(e) => handleInputChangeIntoARefObject( createdTech ,e,"file")} type="file" />
        <FormHelperText id="my-helper-text">
